 ...
 */
public class CS_Filas_Servidor extends CS_Comunicacao implements Vertice {
    ...
    public CS_Filas_Servidor(String id, double TxServico, double TempoPreempcao, double TxAtraso, int Num_filas, String Escalonador, int Capacidade_Fila, double Prob_Falha_Serv, double Prob_Falha_Clie, boolean Capacidade, boolean Origem, boolean Destino) {
