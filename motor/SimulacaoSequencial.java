...
public class SimulacaoSequencial extends Simulacao {
    ...
    private void realizarSimulacao() {
        ...
        //recupera o próximo evento e o executa.
            ...
            //System.out.println("Servidor:" + eventoAtual.getServidor().getId());
            //System.out.println("Evento:" + eventoAtual.getCliente().getTamComunicacao());
            //System.out.println("Tipo:" + eventoAtual.getTipo());
            //System.out.println("Evento:" + eventoAtual.getTempoOcorrencia());
